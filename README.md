...
<br><center><img src="05outputs.png" alt="test image size" height="50%" width="50%"></center><br>
...
<br><center><img src="PWM-diagram.jpg" alt="test image size" height="50%" width="50%"></center><br>
...
<br><center>![UART](UART-BUS-between-two-devices.jpg)</center><br>
...
<br><center><img src="uart3.png" alt="test image size" height="70%" width="70%"></center><br>
...
<br><center><img src="i2c.jpg" alt="test image size" height="50%" width="50%"></center><br>
PWM and UART can only be used to connect two devices. I2C can be used to connect multiple devices.Note that SCL(Serial Clock) and SDA(Serial Data) both connect to VDD with pull-up resisters, so the GPIO should use Open-drain mode<br><center><img src="i2c2.png" alt="test image size" height="50%" width="50%"></center><br>
...
<br><center><img src="main-qimg-272f2b3107dde97977b4de2bb73c63db-c.jpg" alt="test image size" height="50%" width="50%"><br>
<img src="main-qimg-29f1009a3768fb8bc42db2c13c582d62-c.jpg" alt="test image size" height="50%" width="50%"></center><br>
...
<br><center><img src="main-qimg-174fc23dd714c5c56c9d5722fd0de516-c.jpg" alt="test image size" height="50%" width="50%"></center><br>
...
<br><center><img src="main-qimg-871a3258854b57497f74d3d8f8276a2a-c.jpg" alt="test image size" height="50%" width="50%"></center><br>
